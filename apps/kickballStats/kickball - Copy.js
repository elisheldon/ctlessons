...
function loadAthletes(){
    ...
    .then(function(querySnapshot) {
		querySnapshot.forEach(function(doc) {
			...
			document.getElementById("athleteTable").innerHTML += "<tr class='athleteRow' id='" + pl.first + pl.last +"'><td>" + pl.number + ". " + pl.first + " " + pl.last + "</td><td>" + pl.foot + "</td><td>" + pl.arm + "</td><td>" + plStats[0].toFixed(3) + "</td><td>" + plStats[1].toFixed(3) + "</td><td>" + pl.runs + "</td><td>" + plStats[2].toFixed(2) + "</td><td>" + plStats[3] + "</td></tr>";
			$("#loadingDiv").hide();
			$("#athletesDiv").show();
		});
...
function chooseTeams(presentPlayers){
	...
	loadedPlayersShuffled.forEach(function(doc) {
		...
		allPlayers[doc.id] = pl; //allPlayers object contains each player as a child object
		plStats = calcStats(pl);
		document.getElementById("availableTable").innerHTML += "<tr class='availablePlayerRow availablePlayerRowTeamOne' id='" + pl.first + pl.last +"'><td>" + "Player " + pl.anon + "</td><td>" + pl.foot + "</td><td>" + pl.arm + "</td><td>" + plStats[0].toFixed(3) + "</td><td>" + plStats[1].toFixed(3) + "</td><td>" + pl.runs + "</td><td>" + plStats[2].toFixed(2) + "</td><td>" + plStats[3] + "</td></tr>";
	});
	$("#absentUI").hide();
	$("#teamsUI").show();
...
function calcStats(pl){
	...
	era = (pl.er/pl.ip)*7; //are we doing seven inning games?
...
$("#showTeamsWithNames").click(function() {
	...
	Object.entries(t1Players).forEach(function(obj){
		...
		if(typeof(pl.kickright) == "undefined"){pl.kickright = 0};
		plStats = calcStats(pl);
		document.getElementById("teamOneTableWithNames").innerHTML += "<tr><td>" + pl.number + ". " + pl.first + " " + pl.last + "</td><td>" + pl.foot + "</td><td>" + pl.arm + "</td><td>" + plStats[0].toFixed(3) + "</td><td>" + plStats[1].toFixed(3) + "</td><td>" + pl.runs + "</td><td>" + plStats[2].toFixed(2) + "</td><td>" + plStats[3] + "</td></tr>";
	});
	Object.entries(t2Players).forEach(function(obj){
		...
		if(typeof(pl.kickright) == "undefined"){pl.kickright = 0};
		plStats = calcStats(pl);
		document.getElementById("teamTwoTableWithNames").innerHTML += "<tr><td>" + pl.number + ". " + pl.first + " " + pl.last + "</td><td>" + pl.foot + "</td><td>" + pl.arm + "</td><td>" + plStats[0].toFixed(3) + "</td><td>" + plStats[1].toFixed(3) + "</td><td>" + pl.runs + "</td><td>" + plStats[2].toFixed(2) + "</td><td>" + plStats[3] + "</td></tr>";
	});
